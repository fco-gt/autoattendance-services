...
export namespace Prisma {
  ...
  */
  ...
  export type WorkScheduleOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "agencyId" | "name" | "daysOfWeek" | "entryTime" | "exitTime" | "gracePeriodMinutes" | "isDefault" | "assignedUserIds" | "createdAt" | "updatedAt", ExtArgs["result"]["workSchedule"]>
  ...
  interface WorkScheduleFieldRefs {
    ...
    readonly agencyId: FieldRef<"WorkSchedule", 'String'>
    readonly name: FieldRef<"WorkSchedule", 'String'>
    readonly daysOfWeek: FieldRef<"WorkSchedule", 'Int[]'>
    readonly entryTime: FieldRef<"WorkSchedule", 'String'>
    readonly exitTime: FieldRef<"WorkSchedule", 'String'>
    readonly gracePeriodMinutes: FieldRef<"WorkSchedule", 'Int'>
    readonly isDefault: FieldRef<"WorkSchedule", 'Boolean'>
    readonly assignedUserIds: FieldRef<"WorkSchedule", 'String[]'>
  ...
  export type WorkScheduleWhereInput = {
    ...
    agencyId?: StringFilter<"WorkSchedule"> | string
    name?: StringFilter<"WorkSchedule"> | string
    daysOfWeek?: IntNullableListFilter<"WorkSchedule">
    entryTime?: StringFilter<"WorkSchedule"> | string
    exitTime?: StringFilter<"WorkSchedule"> | string
    gracePeriodMinutes?: IntFilter<"WorkSchedule"> | number
    isDefault?: BoolFilter<"WorkSchedule"> | boolean
    assignedUserIds?: StringNullableListFilter<"WorkSchedule">
  ...
  export type WorkScheduleWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    agencyId_name?: WorkScheduleAgencyIdNameCompoundUniqueInput
    AND?: WorkScheduleWhereInput | WorkScheduleWhereInput[]
    OR?: WorkScheduleWhereInput[]
    NOT?: WorkScheduleWhereInput | WorkScheduleWhereInput[]
    agencyId?: StringFilter<"WorkSchedule"> | string
  ...
  export type WorkScheduleScalarWhereWithAggregatesInput = {
    ...
    agencyId?: StringWithAggregatesFilter<"WorkSchedule"> | string
    name?: StringWithAggregatesFilter<"WorkSchedule"> | string
    daysOfWeek?: IntNullableListFilter<"WorkSchedule">
    entryTime?: StringWithAggregatesFilter<"WorkSchedule"> | string
    exitTime?: StringWithAggregatesFilter<"WorkSchedule"> | string
    gracePeriodMinutes?: IntWithAggregatesFilter<"WorkSchedule"> | number
  ...
  export type WorkScheduleCreateInput = {
    ...
    agencyId: string
    name: string
    daysOfWeek?: WorkScheduleCreatedaysOfWeekInput | number[]
    entryTime: string
    exitTime: string
    gracePeriodMinutes?: number
    isDefault?: boolean
    assignedUserIds?: WorkScheduleCreateassignedUserIdsInput | string[]
  ...
  export type WorkScheduleUpdateInput = {
    ...
    daysOfWeek?: WorkScheduleUpdatedaysOfWeekInput | number[]
    ...
    assignedUserIds?: WorkScheduleUpdateassignedUserIdsInput | string[]
  ...
  export type WorkScheduleAgencyIdNameCompoundUniqueInput = {
    agencyId: string
    name: string
  }
  ...
  export type WorkScheduleCreatedaysOfWeekInput = {
    set: number[]
  }

  export type WorkScheduleCreateassignedUserIdsInput = {
    set: string[]
  }
  ...
  export type WorkScheduleUpdatedaysOfWeekInput = {
    set?: number[]
    push?: number | number[]
  }
  ...
  export type WorkScheduleUpdateassignedUserIdsInput = {
    set?: string[]
    push?: string | string[]
  }
